...
Tests for Playwright scraper include:

- **Config tests**: Validate configuration structure
- **Scraper tests**: Test scraping logic with mocked Playwright browser
- **Logger tests**: Verify logging functionality

All tests use mocks to avoid actual network requests and browser launches during testing.
